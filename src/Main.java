...
public class Main extends Application {
    ...
    private String negate(String displayText){
        ...
        return formatOutput(Double.parseDouble(displayText) * -1);
    }
    ...
    private String doLog(double a){
        reset();
        return formatOutput(Math.log(a));
    }
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        Button bsquare = MyButton.buildButton("log(x)", minHeight, minWidth, prefHeight, prefWidth);
        bsquare.setOnAction(actionEvent -> display.setText(updateDisplay("",
                doLog(Double.parseDouble(display.getText())))));
        ...
        b8.setOnAction(actionEvent -> display.setText(
